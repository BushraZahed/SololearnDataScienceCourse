...
#Task
#Given a list of numbers including some missing values,
#  turn it into a pandas series, impute the missing values with the mean, and finally return the series.
